...
namespace ApplicationProject.UserControls.AddExpenseCategoryPageView
{
    ...
    /// </summary>
    public partial class AddExpenseCategoryPageView : UserControl, IAddExpenseCategoryPageView, INotifyPropertyChanged, ICultureDependentData
    {
        protected const string CategoryNameFieldTextKey = "PAGE_ADDEXPENSECATEGORY_NAMEFIELD_NAME";
        protected const string CurrencyAmountFieldTextKey = "PAGE_ADDEXPENSECATEGORY_CURRENCYAMOUNTFIELD_NAME";
        protected const string CategoryImagePathFieldTextKey = "PAGE_ADDEXPENSECATEGORY_CATEGORYIMAGEPATH_NAME";
        protected const string ButtonAddTextKey = "PAGE_ADDEXPENSECATEGORY_BUTTONADD_NAME";
        protected const string ButtonExitTextKey = "PAGE_ADDEXPENSECATEGORY_BUTTONEXIT_NAME";
        protected const string ImageSelectorTextKey = "PAGE_ADDEXPENSECATEGORY_IMAGESELECTOR_NAME";

        public AddExpenseCategoryPageView()
        {
            m_CategoryName = "";
            m_CategoryImagePath = "";
            m_CurrencyAmount = 0;
